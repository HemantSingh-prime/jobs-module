...
import lombok.Data;
@Data
public class JobDetailsResponsePayload {

	@Min(message = "Job Id should not be null",value = 1)
	private int jobId;
	@NotNull
	@NotBlank
	...
	private Set<ResponsePayload> jobLocation;
}
